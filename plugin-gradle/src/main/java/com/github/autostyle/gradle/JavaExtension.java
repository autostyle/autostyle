...
import com.github.autostyle.extra.java.EclipseFormatterStep;
import com.github.autostyle.extra.java.EclipseJdtFormatterStep;
import com.github.autostyle.generic.LicenseHeaderStep;
  ...
  public void importOrder(List<String> importOrder) {
    getProject().getLogger().warn(
        StringPrinter.buildStringFromLines(
            ...
            "For details see https://github.com/autostyle/autostyle/tree/master/plugin-gradle#applying-to-java-source"));
